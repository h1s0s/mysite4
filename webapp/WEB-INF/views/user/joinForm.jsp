...
<body>
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<!-- //aside -->
			<c:import url="/WEB-INF/views/include/asideJoin.jsp"></c:import>
			<div id="content">
				<div id="content-head">
					<h3>회원가입</h3>
					<div id="location">
				...
				<div id="user">
					<div id="joinForm">
						<form action="${pageContext.request.contextPath}/user/join" method="get">
							...
							<!-- //나이 -->
							<div class="form-group">
								<span class="form-text">성별</span> <label for="rdo-male">남</label> <input type="radio" id="rdo-male" name="gender" value="male" checked="checked"> <label for="rdo-female">여</label> <input type="radio" id="rdo-female" name="gender" value="female">
